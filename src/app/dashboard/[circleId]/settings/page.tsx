...
import { CalendarDays, Globe2, LockKeyhole, PiggyBank, Repeat2, Settings } from "lucide-react";
    ...
    >
      <SectionCard title="Locked settings">
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-6">
          ...
          <StatCard label="Cycles" value={`${data.circle.cycleCount} (${data.circle.totalRounds} rounds)`} icon={Repeat2} />
          <StatCard label="Timezone" value={data.circle.timeZone} icon={Globe2} />
